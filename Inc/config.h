...
*/
  // #define DUAL_INPUTS                     // ADC*(Primary) + PWM(Auxiliary). Uncomment this to use Dual-inputs
    ...
    #define FLASH_WRITE_KEY       0x8005  // Flash memory writing key. Change this key to ignore the input calibrations from the flash memory and use the ones in config.h
    ...
    #define PRI_INPUT1            3, -400, 0, 400, 100  // TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
    #define PRI_INPUT2            3, -400, 0, 400, 100  // TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
  #endif
